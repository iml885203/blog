...
```html
{# 顯示相關文章 #} {# 編輯於：_partials/post/post-related.njk #}
...
<ul class="popular-posts">
  <li class="popular-posts-item">
    ...
    <div class="popular-posts-title">
      <a href="/{{ popular_post.path }}" rel="bookmark">{{ popular_post.title }}</a>
    </div>
    {#
...
```html
{# SEO #} {# improve LCP(Largest Contentful Paint) #} <link rel="preconnect" href="https://images.unsplash.com" />
```
...
```html
{# ribbon.js without click #} {# https://github.com/hustcc/ribbon.js #}
<script>
...
<script
  ...
  alpha="0.4"
  zIndex="-1"
  src="https://cdnjs.cloudflare.com/ajax/libs/ribbon.js/1.0.2/ribbon.min.js"
  onload="removeRibbonClick()"
></script>
```
